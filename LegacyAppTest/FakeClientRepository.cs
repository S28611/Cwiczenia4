...
public class FakeClientRepository : IClientRepository
{
    ...
    {
        {1, new Client{ClientId = 1, Name = "Kowalski", Address = "Warszawa, Złota 12", Email = "kowalski@wp.pl", Type = "ImportantClient"}},
        ...
        {7, new Client{ClientId = 7, Name = "Kowalski", Address = "Warszawa, Złota 12", Email = "kowalski@wp.pl", Type = "NormalClient"}}
    };
